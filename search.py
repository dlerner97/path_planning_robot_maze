...
class BFSSearch(Search):
    ...
    # Grabs next node
    def _get_next_branch(self, parent, pos): 
        ...
        if (on_grid):
            ...
            if self.at_goal_pos(pos):
                ...
                self.node_info[loc_string][theta] = {"parent": parent}
    ...
    def _check_subsequent_nodes(self, parent):
        ...
        for branch_info in self.action_set.values(): 
            ...
            found_goal = self._get_next_branch(parent, pos) or found_goal
...
class DijkstraSearch(Search):
    ...
    # Grabs next node
    def _get_next_branch(self, parent, pos, branch_cost): 
        ...
        if (on_grid):
            ...
            if self.at_goal_pos(pos):
                if node_info == None:
                    self.node_info[loc_string] = {}
                self.node_info[loc_string][theta] = {"parent": parent, "cost_from_first": cost_from_first}
                self.winning_loc = pos
                return True 
    ...
    def _check_subsequent_nodes(self, parent):
        ...
        for branch_info in self.action_set.values(): 
            ...
            found_goal = self._get_next_branch(parent, pos, branch_info['cost']) or found_goal
